...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('cssfile/adregister.css') }}">
...
<body>
    <div class="container">
        ...
        <div class="navigation">
                <nav>
                    <ul>
                        ...
                        <li><a href="{{ url('adlogin') }}">Admin Log</a></li>
                    </ul>
                </nav>
            </div>
        ...
        <div class="wrapper">
            <form action="{{ url('/adreg-data') }}" method="POST">
                @csrf
                <h1>Admin</h1>
                <div class="input-box">
                ...
                <div class="register-link">
                    <p>Already have an account?<a href="{{ url('adlogin') }}">  Login</a></p>
                </div>
            </form>
        </div>
        <footer class="footer">
